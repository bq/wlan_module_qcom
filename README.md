...
clone the projects:
        ...
        $ git clone https://github.com/bq/aquaris-C.git ; git clone https://github.com/bq/wlan_module_qcom.git

After it, choose the release you would like to build:

*Aquaris C*

        $ mv aquaris-C kernel ; cd kernel ; git checkout tags/{release} ; cd ..
