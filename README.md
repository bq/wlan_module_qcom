...
clone the projects:
        ...
        $ git clone https://github.com/bq/aquaris-U2-Lite.git ; git clone https://github.com/bq/wlan_module_qcom.git

After it, choose the release you would like to build:

*Aquaris U2 Lite*

        $ mv aquaris-U2-Lite kernel ; cd kernel ; git checkout tags/{release} ; cd ..
