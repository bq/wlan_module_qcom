...
clone the projects:
        ...
        $ git clone https://github.com/bq/aquaris-M5.git ; git clone https://github.com/bq/wlan_module_qcom.git 

After it, choose the release you would like to build:

*Aquaris M5*

        $ mv aquaris-M5 kernel ; cd kernel ; git checkout tags/{release} ; cd ..
