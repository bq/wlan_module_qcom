...
clone the projects:
        ...
        $ git clone https://github.com/bq/aquaris-U-Plus.git ; git clone https://github.com/bq/wlan_module_qcom.git

After it, choose the release you would like to build:

*Aquaris U Plus*

        $ mv aquaris-U-Plus kernel ; cd kernel ; git checkout tags/{release} ; cd ..
